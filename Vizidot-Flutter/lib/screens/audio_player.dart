...
import 'package:vizidot_flutter/utils/common.dart';
import 'package:vizidot_flutter/constants.dart' as consts;

class MainScreen extends StatefulWidget {
  List<MediaItem> mediaItems;

  MainScreen({Key? key, required this.mediaItems}) : super(key: key);
...
class _MainScreenState extends State<MainScreen> {
  Stream<Duration> get _bufferedPositionStream =>
      consts.audioHandler.playbackState
          .map((state) => state.bufferedPosition)
          .distinct();

  Stream<Duration?> get _durationStream =>
      consts.audioHandler.mediaItem.map((item) => item?.duration).distinct();
  ...
  void initState() {
    print("Update Queue");
    consts.audioHandler.seek(Duration(milliseconds: 0));
    consts.audioHandler.updateQueue([]);
    consts.audioHandler.addQueueItems(widget?.mediaItems ?? []);
    consts.audioHandler.play();
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<MediaItem?>(
                stream: consts.audioHandler.mediaItem,
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Text(mediaItem.title, style: TextStyle(color: Colors.white)),
                    ],
                  );
                },
              ),
            ...
            // Playback controls
            ControlButtons(consts.audioHandler),
            // A seek bar.
              ...
              builder: (context, snapshot) {
                ...
                return SeekBar(
                  ...
                  onChangeEnd: (newPosition) {
                    consts.audioHandler.seek(newPosition);
                  },
                );
              },
            ),
            ...
            Row(
              children: [
                StreamBuilder<AudioServiceRepeatMode>(
                  stream: consts.audioHandler.playbackState
                  ...
                  builder: (context, snapshot) {
                    ...
                    return IconButton(
                      icon: icons[index],
                      onPressed: () {
                        consts.audioHandler.setRepeatMode(cycleModes[
                  ...
                  builder: (context, snapshot) {
                    ...
                    return IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await consts.audioHandler.setShuffleMode(enable
            ...
            SizedBox(
              ...
              child: StreamBuilder<QueueState>(
                stream: consts.audioHandler.queueState,
                builder: (context, snapshot) {
                  ...
                  return ReorderableListView(
                    onReorder: (int oldIndex, int newIndex) {
                      ...
                      consts.audioHandler.moveQueueItem(oldIndex, newIndex);
                    },
                    children: [
                      for (var i = 0; i < queue.length; i++)
                        Dismissible(
                          ...
                          onDismissed: (dismissDirection) {
                            consts.audioHandler.removeQueueItemAt(i);
                          },
                          child: Material(
                            color: i == queueState.queueIndex
                                ...
                                : Colors.black,
                            child: ListTile(
                              title: Text(queue[i].title, style: TextStyle(color: Colors.white)),
                              onTap: () =>
                                  consts.audioHandler.skipToQueueItem(i),
                            ),
                          ),
                        ),
                    ],
...
class MediaLibrary {
  static const albumsRootId = 'albums123';

  late Map<String, List<MediaItem>> items = <String, List<MediaItem>>{
    albumsRootId: [
      MediaItem(
